        ...
        <div className="hidden xl:block relative">
          ...
          <div className="absolute top-[20%] p-10">
            ...
            <p className="text-[#f1f1f1] mt-5 w-[80%] text-justify">
              Nike is a global sportswear brand known for its athletic shoes, apparel, and equipment. Founded in 1964,
              it is famous for its innovation, iconic "Swoosh" logo, and "Just Do It" slogan.
            </p>
          </div>
        </div>
          ...
          <form onSubmit={formik.handleSubmit} className="w-full mt-5">
            ...
            <div className="form-group w-full relative mb-5">
              <TextField
                ...
                type={isShowPassword === true ? 'password' : ''}
              />
              {formik.errors.password && formik.touched.password && (
                <div className="text-red-500">{formik.errors.password}</div>
              )}
              <Button
                className="!absolute !text-black !text-[20px] top-[3px] right-[5px] z-50 !w-[50px] !h-[50px] !min-w-[35px]"
